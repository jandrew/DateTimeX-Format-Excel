...
use version 0.77; our $VERSION = qv("v0.12.24");
use	5.010;
use	strict;
use	warnings;
use List::Util 1.33;
...
<a href='https://coveralls.io/r/jandrew/DateTimeX-Format-Excel'><img src='https://coveralls.io/repos/jandrew/DateTimeX-Format-Excel/badge.svg' alt='Coverage Status' /></a>
